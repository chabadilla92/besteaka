                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content rounded-0 border border-dark">
                            <div class="modal-header border-bottom border-white">
                                    <h3>MENU</h3>
                                    <button type="button" class="btn p-0" data-bs-dismiss="modal" aria-label="Close"><i class="bi bi-x"></i></button>
                            </div>
                          <div class="modal-body">
                            ...
                            <img src="besteakamenu 4-4.jpeg" class="img-fluid" alt=""></img></div>
                        </div>
                    </div>
                </div>            
            </div>
