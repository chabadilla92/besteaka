    ...
    <section id="contact">
      ...
      <div class="row p-3 text-md-center">
        <div class="col-md-6 py-3">
          <h3>
            <a href="https://www.facebook.com/BEST%C3%89AK%C4%82-364044414093165/">
              <i class="bi bi-facebook"></i>
            </a>
          </h3>
          <h3 id="contactheader" class="py-2">
            FACEBOOK
          </h3>
        ...
        <div class="col-md-6 py-3">
          <h3>
            <a href="https://www.instagram.com/be.steak.a/?hl=en">
      ...
      <div class="row p-3 text-md-center">
        ...
        <p>
          M-THU: 5 - 9 PM
          <br />
          FRI &#38; SAT: 11:30 AM - 2 PM, 5 - 9 PM
          <br />
          SUN: 10 AM - 2 PM, 5 - 9 PM
        </p>
      </div>
    </section>
  );
